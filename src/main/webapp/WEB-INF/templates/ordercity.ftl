        ...
        <div class="container">
         ...
         null
            ...
            <select name="city">
                ...
                <option label="Барнаул" value="Барнаул"  <#if (city?? && city == "Барнаул")> selected="selected" </#if> >Барнаул</option>
                <option label="Заринск" value="Заринск" <#if (city?? && city == "Заринск")> selected="selected" </#if> >Заринск</option>
                <option label="Бийск" value="Бийск" <#if (city?? && city == "Бийск")> selected="selected" </#if> >Бийск</option>
                ...
                <div class="row ng-scope" ng-if="!$ctrl.noCategory">
                    ...
                    <span class="custom-select">
            <select class="ng-valid ng-not-empty ng-dirty ng-valid-parse ng-touched">
                <option value="" class=""></option>
                <option label="Мелкие бытовые услуги" value="object:53" selected="selected">Мелкие бытовые услуги</option>
                <option label="Комплексные работы" value="object:54">Комплексные работы</option>
                <option label="Строительно-монтажные работы" value="object:55">Строительно-монтажные работы</option><option label="Отделочные работы" value="object:56">Отделочные работы</option><option label="Инженерные системы" value="object:57">Инженерные системы</option><option label="Благоустройство территорий" value="object:58">Благоустройство территорий</option><option label="Проектирование и дизайн" value="object:59">Проектирование и дизайн</option><option label="Обслуживание объектов" value="object:60">Обслуживание объектов</option><option label="Интерьер" value="object:61">Интерьер</option>
            </select>
        </span>
                    <span class="custom-select ng-scope">
            <select class="ng-valid ng-not-empty ng-dirty ng-touched ng-valid-parse">
                <option label="Мебель" value="object:589" selected="selected">Мебель</option>
                <option label="Шторы и карнизы" value="object:590">Шторы и карнизы</option>
                <option label="Офисные перегородки" value="object:591">Офисные перегородки</option><option label="Декорирование интерьеров" value="object:592">Декорирование интерьеров</option><option label="Жалюзи" value="object:593">Жалюзи</option><option label="Фитодизайн" value="object:594">Фитодизайн</option>
            </select>
                    </span>
                </div>
                    ...
                    <div class="orders-list-block__wrap">
                        <div class="orders-list-block__wrap-inner">
                            ...
                            <div class="order-block" id=${order.id}>
                                ...
                                <div class="details">
                                    <a class="as-text" target="_self" href="/order/${order.id}">
                                        ${order.body}
                                    </a>
                                </div>
                                <div class="footer">
